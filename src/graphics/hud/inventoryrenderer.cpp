...
void InventoryRenderer::drawArmorItem(const Inventory& inventory, int slot, float dx, float dy, float hw, float hh) {
...
void InventoryRenderer::draw(const Inventory& inventory) {
    ...
    drawArmorItem(inventory, inventory.HEAD_SLOT, 0.0f, +0.15f, 0.11f * 0.5f, 0.11f * 0.5f);
    drawArmorItem(inventory, inventory.TORSO_SLOT, 0.0f, 0.0f, 0.1f * 0.5f, 0.15f * 0.5f);
    drawArmorItem(inventory, inventory.LEGS_SLOT, 0.0f, -0.24f, 0.1f * 0.5f, 0.15f * 0.5f);
    drawArmorItem(inventory, inventory.BELT_SLOT, 0.0f, -0.12f, 0.1f * 0.5f, 0.1f * 0.5f);
    drawArmorItem(inventory, inventory.ARMS_SLOT, +0.1f, +0.075f, 0.1f * 0.5f, 0.1f * 0.5f);
    drawArmorItem(inventory, inventory.ARMS_SLOT, -0.1f, +0.075f, 0.1f * 0.5f, 0.1f * 0.5f);
    drawArmorItem(inventory, inventory.AMULET_SLOT, 0.0f, +0.06f, 0.1f * 0.5f, 0.1f * 0.5f);
